...
export default function Login() {
  ...
  return (
    <>
      <Head><title>Connexion · Photo Studio</title></Head>
      <div className="page">
        <div className="box">
          ...
          <p className="sub">Accède à ton studio</p>
          ...
          <p className="foot">Pas de compte ? <Link href="/register" className="accent-link">Créer un compte</Link></p>
        </div>
      </div>
      <style jsx>{`
