...
export const OPTIONS = {
  ...
  background: {
    ...
    choices: [
      // ===== FOND FOURRURE INFINI =====
      // Approche : "endless fur surface" au lieu de "rug" — Kontext ne génère
      // pas un objet avec des bords. Le fond remplit 100% du frame.
      { id: 'rug_white_snow', label: 'Blanc Neige', category: 'rug', swatch: '#F5F0E6',
        prompt: 'Place the garment directly on an endless fluffy faux fur surface in soft ivory cream color, ultra soft plush texture with long visible fibers (approximately 4 cm) naturally arranged in soft wavy clusters and patches, realistic fur appearance. The fluffy fur surface is the ONLY thing visible in the entire image besides the garment — it covers 100% of every pixel, from one edge of the frame to the other, extending infinitely in all directions far beyond the photograph. There is no floor, no wall, no furniture, no plant, no rug boundary, no transition between surfaces visible anywhere. Top-down close-up flat-lay view. Natural soft daylight. Authentic e-commerce listing photograph style.' },

      { id: 'rug_beige_cream', label: 'Beige Crème', category: 'rug', swatch: '#E5D5BC',
        prompt: 'Place the garment directly on an endless fluffy faux fur surface in warm cream beige color, ultra soft plush texture with long visible fibers (approximately 4 cm) naturally arranged in soft wavy clusters, realistic fur appearance. The fluffy fur surface is the ONLY thing visible in the entire image besides the garment — it covers 100% of every pixel, extending infinitely in all directions far beyond the photograph. There is no floor, no wall, no furniture, no rug boundary anywhere. Top-down close-up flat-lay view. Natural soft daylight.' },

      { id: 'rug_anthracite', label: 'Anthracite', category: 'rug', swatch: '#3A3A3A',
        prompt: 'Place the garment directly on an endless fluffy faux fur surface in dark anthracite gray color, ultra soft plush texture with long visible fibers (approximately 4 cm) naturally arranged in soft wavy clusters, realistic fur appearance. The fluffy fur surface is the ONLY thing visible in the entire image besides the garment — it covers 100% of every pixel, extending infinitely in all directions far beyond the photograph. There is no floor, no wall, no furniture, no rug boundary anywhere. Top-down close-up flat-lay view. Natural soft daylight.' },

      { id: 'rug_teal', label: 'Bleu Canard', category: 'rug', swatch: '#1F5F6B',
        prompt: 'Place the garment directly on an endless fluffy faux fur surface in rich teal blue color, ultra soft plush texture with long visible fibers (approximately 4 cm) naturally arranged in soft wavy clusters, realistic fur appearance. The fluffy fur surface is the ONLY thing visible in the entire image besides the garment — it covers 100% of every pixel, extending infinitely in all directions far beyond the photograph. There is no floor, no wall, no rug boundary anywhere. Top-down close-up flat-lay view. Natural soft daylight.' },

      { id: 'rug_dusty_rose', label: 'Vieux Rose', category: 'rug', swatch: '#C9959A',
        prompt: 'Place the garment directly on an endless fluffy faux fur surface in dusty rose pink color, ultra soft plush texture with long visible fibers (approximately 4 cm) naturally arranged in soft wavy clusters, realistic fur appearance. The fluffy fur surface is the ONLY thing visible in the entire image besides the garment — it covers 100% of every pixel, extending infinitely in all directions far beyond the photograph. There is no floor, no wall, no rug boundary anywhere. Top-down close-up flat-lay view. Natural soft daylight.' },

      { id: 'rug_royal_blue', label: 'Bleu Roi', category: 'rug', swatch: '#1F3C8C',
        prompt: 'Place the garment directly on an endless fluffy faux fur surface in vibrant royal blue color, ultra soft plush texture with long visible fibers (approximately 4 cm) naturally arranged in soft wavy clusters, realistic fur appearance. The fluffy fur surface is the ONLY thing visible in the entire image besides the garment — it covers 100% of every pixel, extending infinitely in all directions far beyond the photograph. There is no floor, no wall, no rug boundary anywhere. Top-down close-up flat-lay view. Natural soft daylight.' },

      { id: 'rug_mustard', label: 'Jaune Moutarde', category: 'rug', swatch: '#C99A2E',
        prompt: 'Place the garment directly on an endless fluffy faux fur surface in warm mustard yellow color, ultra soft plush texture with long visible fibers (approximately 4 cm) naturally arranged in soft wavy clusters, realistic fur appearance. The fluffy fur surface is the ONLY thing visible in the entire image besides the garment — it covers 100% of every pixel, extending infinitely in all directions far beyond the photograph. There is no floor, no wall, no rug boundary anywhere. Top-down close-up flat-lay view. Natural soft daylight.' },

      { id: 'rug_emerald', label: 'Vert Émeraude', category: 'rug', swatch: '#2A6A4E',
        prompt: 'Place the garment directly on an endless fluffy faux fur surface in deep emerald green color, ultra soft plush texture with long visible fibers (approximately 4 cm) naturally arranged in soft wavy clusters, realistic fur appearance. The fluffy fur surface is the ONLY thing visible in the entire image besides the garment — it covers 100% of every pixel, extending infinitely in all directions far beyond the photograph. There is no floor, no wall, no rug boundary anywhere. Top-down close-up flat-lay view. Natural soft daylight.' },

      { id: 'rug_sienna', label: 'Terre de Sienne', category: 'rug', swatch: '#9C5536',
        prompt: 'Place the garment directly on an endless fluffy faux fur surface in warm terracotta sienna brown color, ultra soft plush texture with long visible fibers (approximately 4 cm) naturally arranged in soft wavy clusters, realistic fur appearance. The fluffy fur surface is the ONLY thing visible in the entire image besides the garment — it covers 100% of every pixel, extending infinitely in all directions far beyond the photograph. There is no floor, no wall, no rug boundary anywhere. Top-down close-up flat-lay view. Natural soft daylight.' },

      { id: 'rug_lavender', label: 'Lavande', category: 'rug', swatch: '#A89CC8',
        prompt: 'Place the garment directly on an endless fluffy faux fur surface in soft lavender purple color, ultra soft plush texture with long visible fibers (approximately 4 cm) naturally arranged in soft wavy clusters, realistic fur appearance. The fluffy fur surface is the ONLY thing visible in the entire image besides the garment — it covers 100% of every pixel, extending infinitely in all directions far beyond the photograph. There is no floor, no wall, no rug boundary anywhere. Top-down close-up flat-lay view. Natural soft daylight.' },

      { id: 'rug_jute', label: 'Jute Tissé', category: 'rug', swatch: '#B8A179',
        prompt: 'Place the garment directly on an endless natural jute woven surface in warm beige-tan color, tightly woven flat texture with subtle visible weave pattern. The jute surface is the ONLY thing visible in the entire image besides the garment — it covers 100% of every pixel, extending infinitely in all directions. There is no floor, no wall, no rug boundary anywhere. Top-down close-up flat-lay view. Natural soft daylight.' },
