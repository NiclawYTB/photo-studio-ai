...
export const OPTIONS = {
  ...
  background: {
    ...
    choices: [
      // ===== TAPIS SHAGGY =====
      // Chaque prompt est ULTRA détaillé pour produire un tapis épais à longues fibres,
      // pas une simple texture. Inspiré du style Vinted/marketplace vintage.
      { id: 'rug_white_snow', label: 'Blanc Neige', category: 'rug', swatch: '#F5F0E6',
        prompt: 'Place the garment on a thick deep-pile shaggy rug in soft ivory white, with very long fluffy fibers extending visibly throughout the entire frame. The fibers are voluminous, soft, and irregularly arranged like a real plush rug, with subtle natural shadows between fiber clusters. The rug fills the entire background — no floor, edges, walls, or props visible. Light variations between fibers create gentle organic depth. Marketplace flat-lay aesthetic.' },

      { id: 'rug_beige_cream', label: 'Beige Crème', category: 'rug', swatch: '#E5D5BC',
        prompt: 'Place the garment on a thick deep-pile shaggy rug in warm cream beige, with very long fluffy fibers extending visibly throughout the entire frame. The fibers are voluminous and soft, slightly varied between light cream and warm sand tones. The rug fills the entire background — no edges visible. Marketplace flat-lay aesthetic.' },

      { id: 'rug_anthracite', label: 'Anthracite', category: 'rug', swatch: '#3A3A3A',
        prompt: 'Place the garment on a thick deep-pile shaggy rug in dark anthracite gray, with very long fluffy fibers extending visibly throughout the entire frame. The fibers are voluminous and dense, with subtle variations between charcoal and slate tones. The rug fills the entire background. Marketplace flat-lay aesthetic.' },

      { id: 'rug_teal', label: 'Bleu Canard', category: 'rug', swatch: '#1F5F6B',
        prompt: 'Place the garment on a thick deep-pile shaggy rug in rich teal blue, with very long fluffy fibers extending visibly throughout the entire frame. The fibers are voluminous, with natural variations between dark teal and turquoise tones. The rug fills the entire background. Marketplace flat-lay aesthetic.' },

      { id: 'rug_dusty_rose', label: 'Vieux Rose', category: 'rug', swatch: '#C9959A',
        prompt: 'Place the garment on a thick deep-pile shaggy rug in muted dusty rose pink, with very long fluffy fibers extending visibly throughout the entire frame. The fibers are voluminous and soft. The rug fills the entire background. Marketplace flat-lay aesthetic.' },

      { id: 'rug_royal_blue', label: 'Bleu Roi', category: 'rug', swatch: '#1F3C8C',
        prompt: 'Place the garment on a thick deep-pile shaggy rug in vibrant royal blue, with very long fluffy fibers extending visibly throughout the entire frame. The fibers are voluminous and dense. The rug fills the entire background. Marketplace flat-lay aesthetic.' },

      { id: 'rug_mustard', label: 'Jaune Moutarde', category: 'rug', swatch: '#C99A2E',
        prompt: 'Place the garment on a thick deep-pile shaggy rug in warm mustard yellow, with very long fluffy fibers extending visibly throughout the entire frame. The fibers are voluminous, slightly varied between deep mustard and ochre tones. The rug fills the entire background. Marketplace flat-lay aesthetic.' },

      { id: 'rug_emerald', label: 'Vert Émeraude', category: 'rug', swatch: '#2A6A4E',
        prompt: 'Place the garment on a thick deep-pile shaggy rug in deep emerald green, with very long fluffy fibers extending visibly throughout the entire frame. The fibers are voluminous and dense. The rug fills the entire background. Marketplace flat-lay aesthetic.' },

      { id: 'rug_sienna', label: 'Terre de Sienne', category: 'rug', swatch: '#9C5536',
        prompt: 'Place the garment on a thick deep-pile shaggy rug in warm terracotta sienna brown, with very long fluffy fibers extending visibly throughout the entire frame. The fibers are voluminous. The rug fills the entire background. Marketplace flat-lay aesthetic.' },

      { id: 'rug_lavender', label: 'Lavande', category: 'rug', swatch: '#A89CC8',
        prompt: 'Place the garment on a thick deep-pile shaggy rug in soft lavender purple, with very long fluffy fibers extending visibly throughout the entire frame. The fibers are voluminous and soft. The rug fills the entire background. Marketplace flat-lay aesthetic.' },

      { id: 'rug_jute', label: 'Jute Tissé', category: 'rug', swatch: '#B8A179',
        prompt: 'Place the garment on a woven natural jute rug with visible tight weave texture, warm beige-tan color. The rug surface is flat but textured with natural fiber weave pattern visible throughout. The rug fills the entire background. Marketplace flat-lay aesthetic.' },
