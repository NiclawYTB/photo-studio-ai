  ...
  background: {
    ...
    choices: [
      ...
      { id: 'desk_plant', label: 'Végétal', category: 'electronique', tab: 'bureau', swatch: '#1F3D2A',
        forceSupport: 'The product is presented standing upright and vertical on a small clear transparent acrylic display stand, front facing the camera, with a subtle soft reflection on the smooth surface just below it.',
        prompt: 'Place the product in front of a lush dense wall of tropical green foliage — ferns, large monstera leaves and small succulents — that completely fills the entire background and is softly out of focus with creamy bokeh (shallow depth of field). Dark moody deep-green ambiance, soft directional light gently illuminating the product so it pops against the darker greenery. Premium collector and reseller product photograph, rich saturated greens, the product perfectly sharp and in focus.' },
