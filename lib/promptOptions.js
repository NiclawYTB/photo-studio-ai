...
export const OPTIONS = {
  ...
  background: {
    ...
    choices: [
      // ===== TEXTURES MOUTONNEUSES =====
      // Style sheepskin / faux fur dense — vue de très près, remplit l'entièreté du
      // frame, AUCUN bord/coin/fin de tapis visible. Texture organique bouclée.
      { id: 'rug_white_snow', label: 'Blanc Neige', category: 'rug', swatch: '#F5F0E6',
        prompt: 'Place the garment on an extremely dense, plush, soft sheepskin fleece texture in pure soft ivory white. The texture is composed of countless tightly packed curly woolly fibers, organic and irregular, with natural depth and subtle shadows between fiber clusters. The texture fills the ENTIRE background and extends infinitely beyond the visible frame — NO edges, NO corners, NO rug border, NO walls, NO floor visible anywhere. Macro close-up perspective showing every individual woolly curl. Pure organic plush fleece atmosphere.' },

      { id: 'rug_beige_cream', label: 'Beige Crème', category: 'rug', swatch: '#E5D5BC',
        prompt: 'Place the garment on an extremely dense, plush, soft sheepskin fleece texture in warm cream beige tones. The texture is composed of countless tightly packed curly woolly fibers, organic and irregular, with subtle warm sand variations. The texture fills the ENTIRE background and extends infinitely beyond the visible frame — NO edges, NO corners, NO rug border visible anywhere. Macro close-up perspective showing every woolly curl.' },

      { id: 'rug_anthracite', label: 'Anthracite', category: 'rug', swatch: '#3A3A3A',
        prompt: 'Place the garment on an extremely dense, plush, soft sheepskin fleece texture in dark anthracite gray tones. The texture is composed of countless tightly packed curly woolly fibers, organic and irregular, with subtle charcoal-to-slate variations. The texture fills the ENTIRE background and extends infinitely beyond the visible frame — NO edges, NO corners, NO rug border visible. Macro close-up perspective.' },

      { id: 'rug_teal', label: 'Bleu Canard', category: 'rug', swatch: '#1F5F6B',
        prompt: 'Place the garment on an extremely dense, plush, soft sheepskin fleece texture in rich teal blue tones. The texture is composed of countless tightly packed curly woolly fibers, organic and irregular. The texture fills the ENTIRE background and extends infinitely beyond the visible frame — NO edges, NO corners visible. Macro close-up perspective.' },

      { id: 'rug_dusty_rose', label: 'Vieux Rose', category: 'rug', swatch: '#C9959A',
        prompt: 'Place the garment on an extremely dense, plush, soft sheepskin fleece texture in muted dusty rose pink tones. The texture is composed of countless tightly packed curly woolly fibers, organic and irregular. The texture fills the ENTIRE background and extends infinitely beyond the visible frame — NO edges, NO corners visible. Macro close-up perspective.' },

      { id: 'rug_royal_blue', label: 'Bleu Roi', category: 'rug', swatch: '#1F3C8C',
        prompt: 'Place the garment on an extremely dense, plush, soft sheepskin fleece texture in vibrant royal blue tones. The texture is composed of countless tightly packed curly woolly fibers, organic and irregular. The texture fills the ENTIRE background and extends infinitely beyond the visible frame — NO edges visible. Macro close-up perspective.' },

      { id: 'rug_mustard', label: 'Jaune Moutarde', category: 'rug', swatch: '#C99A2E',
        prompt: 'Place the garment on an extremely dense, plush, soft sheepskin fleece texture in warm mustard yellow tones. The texture is composed of countless tightly packed curly woolly fibers, organic and irregular, with mustard-to-ochre variations. The texture fills the ENTIRE background and extends infinitely beyond the visible frame — NO edges visible. Macro close-up perspective.' },

      { id: 'rug_emerald', label: 'Vert Émeraude', category: 'rug', swatch: '#2A6A4E',
        prompt: 'Place the garment on an extremely dense, plush, soft sheepskin fleece texture in deep emerald green tones. The texture is composed of countless tightly packed curly woolly fibers, organic and irregular. The texture fills the ENTIRE background and extends infinitely beyond the visible frame — NO edges visible. Macro close-up perspective.' },

      { id: 'rug_sienna', label: 'Terre de Sienne', category: 'rug', swatch: '#9C5536',
        prompt: 'Place the garment on an extremely dense, plush, soft sheepskin fleece texture in warm terracotta sienna brown tones. The texture is composed of countless tightly packed curly woolly fibers, organic and irregular. The texture fills the ENTIRE background and extends infinitely beyond the visible frame — NO edges visible. Macro close-up perspective.' },

      { id: 'rug_lavender', label: 'Lavande', category: 'rug', swatch: '#A89CC8',
        prompt: 'Place the garment on an extremely dense, plush, soft sheepskin fleece texture in soft lavender purple tones. The texture is composed of countless tightly packed curly woolly fibers, organic and irregular. The texture fills the ENTIRE background and extends infinitely beyond the visible frame — NO edges visible. Macro close-up perspective.' },

      { id: 'rug_jute', label: 'Jute Tissé', category: 'rug', swatch: '#B8A179',
        prompt: 'Place the garment on a tightly woven natural jute texture, warm beige-tan color, with visible tight weave pattern throughout. The texture is flat but organically textured. The texture fills the ENTIRE background and extends infinitely beyond the visible frame — NO edges, NO corners visible. Macro close-up perspective showing the woven pattern.' },
