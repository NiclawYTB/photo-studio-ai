...
export const OPTIONS = {
  ...
  background: {
    ...
    choices: [
      // ===== TAPIS SHAGGY MOELLEUX (fibres moyennes, rendu naturel) =====
      // Fibres moyennes (2-3 cm), softness naturelle, AUCUN bord visible,
      // rendu type photo Vinted authentique — pas l'esthétique "IA".
      { id: 'rug_white_snow', label: 'Blanc Neige', category: 'rug', swatch: '#F5F0E6',
        prompt: 'Place the garment on a soft fluffy plush rug in off-white ivory color, with medium-length fibers (approximately 2 to 3 cm), softly arranged with natural irregularities and subtle tonal variations between cream, ivory and warm white. CRITICAL: the rug texture must completely fill the entire image edge-to-edge with absolutely NO visible borders, corners, edges, or rug ends anywhere — as if this photo is a tight crop of a much larger continuous rug surface that extends well beyond the photograph. Authentic natural photograph style, like a real Vinted or marketplace listing photo, not a stylized AI render. Soft natural ambient daylight, gentle shadows.' },

      { id: 'rug_beige_cream', label: 'Beige Crème', category: 'rug', swatch: '#E5D5BC',
        prompt: 'Place the garment on a soft fluffy plush rug in warm cream beige color, with medium-length fibers (approximately 2 to 3 cm), softly arranged with natural irregularities and subtle tonal variations. CRITICAL: the rug texture must completely fill the entire image edge-to-edge with absolutely NO visible borders, corners, edges, or rug ends anywhere — as if this photo is a tight crop of a much larger continuous rug. Authentic natural photograph style, like a real marketplace listing photo, not a stylized AI render. Soft natural daylight.' },

      { id: 'rug_anthracite', label: 'Anthracite', category: 'rug', swatch: '#3A3A3A',
        prompt: 'Place the garment on a soft fluffy plush rug in dark anthracite gray color, with medium-length fibers (approximately 2 to 3 cm), softly arranged with natural irregularities and subtle tonal variations between charcoal and slate. CRITICAL: the rug must fill the entire image edge-to-edge with absolutely NO visible borders, corners, or rug ends anywhere — as if cropped from a much larger continuous rug. Authentic natural photograph style, not a stylized AI render. Soft natural daylight.' },

      { id: 'rug_teal', label: 'Bleu Canard', category: 'rug', swatch: '#1F5F6B',
        prompt: 'Place the garment on a soft fluffy plush rug in rich teal blue color, with medium-length fibers (approximately 2 to 3 cm), softly arranged with natural irregularities. CRITICAL: the rug must fill the entire image edge-to-edge with absolutely NO visible borders, corners, or rug ends anywhere — as if cropped from a much larger rug. Authentic natural photograph style, not a stylized AI render. Soft natural daylight.' },

      { id: 'rug_dusty_rose', label: 'Vieux Rose', category: 'rug', swatch: '#C9959A',
        prompt: 'Place the garment on a soft fluffy plush rug in muted dusty rose pink color, with medium-length fibers (approximately 2 to 3 cm), softly arranged with natural irregularities. CRITICAL: the rug must fill the entire image edge-to-edge with absolutely NO visible borders, corners, or rug ends anywhere — as if cropped from a much larger rug. Authentic natural photograph style, not a stylized AI render. Soft natural daylight.' },

      { id: 'rug_royal_blue', label: 'Bleu Roi', category: 'rug', swatch: '#1F3C8C',
        prompt: 'Place the garment on a soft fluffy plush rug in vibrant royal blue color, with medium-length fibers (approximately 2 to 3 cm), softly arranged with natural irregularities. CRITICAL: the rug must fill the entire image edge-to-edge with absolutely NO visible borders, corners, or rug ends anywhere — as if cropped from a much larger rug. Authentic natural photograph style, not a stylized AI render. Soft natural daylight.' },

      { id: 'rug_mustard', label: 'Jaune Moutarde', category: 'rug', swatch: '#C99A2E',
        prompt: 'Place the garment on a soft fluffy plush rug in warm mustard yellow color, with medium-length fibers (approximately 2 to 3 cm), softly arranged with natural irregularities and ochre variations. CRITICAL: the rug must fill the entire image edge-to-edge with absolutely NO visible borders, corners, or rug ends anywhere — as if cropped from a much larger rug. Authentic natural photograph style, not a stylized AI render. Soft natural daylight.' },

      { id: 'rug_emerald', label: 'Vert Émeraude', category: 'rug', swatch: '#2A6A4E',
        prompt: 'Place the garment on a soft fluffy plush rug in deep emerald green color, with medium-length fibers (approximately 2 to 3 cm), softly arranged with natural irregularities. CRITICAL: the rug must fill the entire image edge-to-edge with absolutely NO visible borders, corners, or rug ends anywhere — as if cropped from a much larger rug. Authentic natural photograph style, not a stylized AI render. Soft natural daylight.' },

      { id: 'rug_sienna', label: 'Terre de Sienne', category: 'rug', swatch: '#9C5536',
        prompt: 'Place the garment on a soft fluffy plush rug in warm terracotta sienna brown color, with medium-length fibers (approximately 2 to 3 cm), softly arranged with natural irregularities. CRITICAL: the rug must fill the entire image edge-to-edge with absolutely NO visible borders, corners, or rug ends anywhere — as if cropped from a much larger rug. Authentic natural photograph style, not a stylized AI render. Soft natural daylight.' },

      { id: 'rug_lavender', label: 'Lavande', category: 'rug', swatch: '#A89CC8',
        prompt: 'Place the garment on a soft fluffy plush rug in soft lavender purple color, with medium-length fibers (approximately 2 to 3 cm), softly arranged with natural irregularities. CRITICAL: the rug must fill the entire image edge-to-edge with absolutely NO visible borders, corners, or rug ends anywhere — as if cropped from a much larger rug. Authentic natural photograph style, not a stylized AI render. Soft natural daylight.' },

      { id: 'rug_jute', label: 'Jute Tissé', category: 'rug', swatch: '#B8A179',
        prompt: 'Place the garment on a tightly woven flat natural jute texture, warm beige-tan color, with subtle visible weave pattern. CRITICAL: the texture must fill the entire image edge-to-edge with absolutely NO visible borders, corners, or rug ends anywhere — as if cropped from a much larger jute surface. Authentic natural photograph style. Soft natural daylight.' },
