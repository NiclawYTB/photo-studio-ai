...
export const OPTIONS = {
    ...
    choicesByCategory: {
      ...
      electronique: [
        ...
        { id: 'jeu',        label: 'Jeu vidéo', icon: '💿',
          prompt: 'Video game case shown from the front, cover artwork fully visible and sharp, standing or flat.' },
  ...
  background: {
    ...
    choices: [
      ...
      { id: 'desk_plant', label: 'Végétal', category: 'electronique', tab: 'bureau', swatch: '#6E8B5A',
        prompt: 'Place the device on a clean modern desk with a softly blurred background featuring green indoor plants and natural daylight, lifestyle product photography, the device sharp and in focus.' },
      ...
      { id: 'desk_shelf', label: 'Étagère', category: 'electronique', tab: 'bureau', swatch: '#8A6B4F',
...
export function buildPrompt(selections = {}) {
  ...
  // Tapis (vêtement) → on force le flat-lay pour la cohérence visuelle
