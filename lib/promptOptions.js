...
export const OPTIONS = {
  ...
  background: {
    ...
    choices: [
      // ===== TAPIS SHAGGY À LONGUES FIBRES =====
      // Style Flokati / IKEA shaggy : fibres longues (3-5cm), individuelles, visibles,
      // un peu désordonnées, qui rayonnent dans toutes les directions.
      // Macro / entire frame / pas de bords visibles.
      { id: 'rug_white_snow', label: 'Blanc Neige', category: 'rug', swatch: '#F5F0E6',
        prompt: 'Place the garment on a high-pile shaggy plush rug in off-white ivory cream color, composed of long thick individual fluffy yarn strands (approximately 4 to 6 cm long) clearly visible as separate fibers radiating outward in all directions, not densely packed but soft and voluminous, with natural shadows visible between individual strands creating depth. The texture fills the ENTIRE background and extends well beyond the visible frame — NO edges, NO corners, NO rug border visible anywhere. Top-down flat-lay view, soft natural lighting. Style: Flokati rug or IKEA shaggy plush rug.' },

      { id: 'rug_beige_cream', label: 'Beige Crème', category: 'rug', swatch: '#E5D5BC',
        prompt: 'Place the garment on a high-pile shaggy plush rug in warm cream beige color, composed of long thick individual fluffy yarn strands (approximately 4 to 6 cm long) clearly visible as separate fibers radiating outward in all directions, with natural shadows visible between strands. The texture fills the ENTIRE background and extends well beyond the visible frame — NO edges, NO corners visible. Top-down flat-lay view, soft natural lighting. Style: Flokati or IKEA shaggy rug.' },

      { id: 'rug_anthracite', label: 'Anthracite', category: 'rug', swatch: '#3A3A3A',
        prompt: 'Place the garment on a high-pile shaggy plush rug in dark anthracite gray color, composed of long thick individual fluffy yarn strands (approximately 4 to 6 cm long) clearly visible as separate fibers radiating outward, with natural shadows between strands. The texture fills the ENTIRE background and extends well beyond the visible frame — NO edges visible. Top-down flat-lay view. Style: Flokati or IKEA shaggy rug.' },

      { id: 'rug_teal', label: 'Bleu Canard', category: 'rug', swatch: '#1F5F6B',
        prompt: 'Place the garment on a high-pile shaggy plush rug in rich teal blue color, composed of long thick individual fluffy yarn strands (approximately 4 to 6 cm long) clearly visible as separate fibers radiating outward. The texture fills the ENTIRE background and extends well beyond the visible frame — NO edges visible. Top-down flat-lay view. Style: shaggy plush rug.' },

      { id: 'rug_dusty_rose', label: 'Vieux Rose', category: 'rug', swatch: '#C9959A',
        prompt: 'Place the garment on a high-pile shaggy plush rug in muted dusty rose pink color, composed of long thick individual fluffy yarn strands (approximately 4 to 6 cm long) clearly visible as separate fibers radiating outward. The texture fills the ENTIRE background and extends well beyond the visible frame — NO edges visible. Top-down flat-lay view. Style: shaggy plush rug.' },

      { id: 'rug_royal_blue', label: 'Bleu Roi', category: 'rug', swatch: '#1F3C8C',
        prompt: 'Place the garment on a high-pile shaggy plush rug in vibrant royal blue color, composed of long thick individual fluffy yarn strands (approximately 4 to 6 cm long) clearly visible as separate fibers radiating outward. The texture fills the ENTIRE background and extends well beyond the visible frame — NO edges visible. Top-down flat-lay view. Style: shaggy plush rug.' },

      { id: 'rug_mustard', label: 'Jaune Moutarde', category: 'rug', swatch: '#C99A2E',
        prompt: 'Place the garment on a high-pile shaggy plush rug in warm mustard yellow color, composed of long thick individual fluffy yarn strands (approximately 4 to 6 cm long) clearly visible as separate fibers radiating outward. The texture fills the ENTIRE background and extends well beyond the visible frame — NO edges visible. Top-down flat-lay view. Style: shaggy plush rug.' },

      { id: 'rug_emerald', label: 'Vert Émeraude', category: 'rug', swatch: '#2A6A4E',
        prompt: 'Place the garment on a high-pile shaggy plush rug in deep emerald green color, composed of long thick individual fluffy yarn strands (approximately 4 to 6 cm long) clearly visible as separate fibers radiating outward. The texture fills the ENTIRE background and extends well beyond the visible frame — NO edges visible. Top-down flat-lay view. Style: shaggy plush rug.' },

      { id: 'rug_sienna', label: 'Terre de Sienne', category: 'rug', swatch: '#9C5536',
        prompt: 'Place the garment on a high-pile shaggy plush rug in warm terracotta sienna brown color, composed of long thick individual fluffy yarn strands (approximately 4 to 6 cm long) clearly visible as separate fibers radiating outward. The texture fills the ENTIRE background and extends well beyond the visible frame — NO edges visible. Top-down flat-lay view. Style: shaggy plush rug.' },

      { id: 'rug_lavender', label: 'Lavande', category: 'rug', swatch: '#A89CC8',
        prompt: 'Place the garment on a high-pile shaggy plush rug in soft lavender purple color, composed of long thick individual fluffy yarn strands (approximately 4 to 6 cm long) clearly visible as separate fibers radiating outward. The texture fills the ENTIRE background and extends well beyond the visible frame — NO edges visible. Top-down flat-lay view. Style: shaggy plush rug.' },

      { id: 'rug_jute', label: 'Jute Tissé', category: 'rug', swatch: '#B8A179',
        prompt: 'Place the garment on a tightly woven flat natural jute texture, warm beige-tan color, with visible tight basketweave pattern throughout. The texture fills the ENTIRE background and extends well beyond the visible frame — NO edges visible. Top-down flat-lay view.' },
