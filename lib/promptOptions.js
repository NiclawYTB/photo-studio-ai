    ...
    choicesByCategory: {
      ...
      electronique: [
        { id: 'front', label: 'De face',
          prompt: 'Product photographed straight from the front, face-on at eye level, the front of the product fully facing the camera, centered and upright.' },
        { id: 'top',   label: 'De dessus',
          prompt: "Product photographed from directly above (top-down bird's-eye view), lying flat, centered, viewed straight down." },
        { id: 'three_quarter', label: 'Trois-quarts',
          prompt: 'Product photographed at a flattering three-quarter angle, slightly above eye level, showing the front and one side for natural depth.' },
      ],
    },
  },
...
export function buildPrompt(selections = {}) {
  ...
  //  - Fond avec mise en scène imposée (ex. Végétal = trois-quarts) → on l'applique
